...
public class LiveConvertedEventHandler extends LiveEventHandler<LiveConvertedPayload> {
    private final UserServiceClient userServiceClient;
   private final NotificationProducer notificationProducer;
    protected LiveConvertedEventHandler(EventLogService eventLogService, UserServiceClient userServiceClient, NotificationProducer notificationProducer) {
    ...
    @Override
    public void helper(LiveEvent<LiveConvertedPayload> event, EventLog eventLog) {
