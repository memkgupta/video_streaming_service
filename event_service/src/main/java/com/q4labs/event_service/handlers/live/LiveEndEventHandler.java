...
@Component
public class LiveEndEventHandler extends LiveEventHandler<LiveEndPayload> {
    private final UserServiceClient userServiceClient;
    private final NotificationProducer notificationProducer;
    protected LiveEndEventHandler(EventLogService eventLogService, UserServiceClient userServiceClient, NotificationProducer notificationProducer) {
    ...
    @Override
    public void helper(LiveEvent<LiveEndPayload> event, EventLog eventLog) {
