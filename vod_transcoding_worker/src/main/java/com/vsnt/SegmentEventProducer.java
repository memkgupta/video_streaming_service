    ...
    public void sendFinishEvent(TranscodingFinishEventDTO event) {
        ...
        producer.send(record, (metadata, exception) -> {
            if (exception != null) {
                ...
                logger.info("Finish event sent. mediaId={}, offset={}",
                        key, metadata.offset());
            }
        });
    }
    ...
    public void sendFinishEvent(AssetTranscodingCompletedEvent event) {
        ...
        producer.send(record, (metadata, exception) -> {
            if (exception != null) {
                ...
                logger.info("Completed event sent. assetId={}, offset={}",
                        key, metadata.offset());
            }
        });
    }
    ...
    public void sendFailedEvent(TranscodingFailedDTO event) {
        ...
        producer.send(record, (metadata, exception) -> {
            if (exception != null) {
                ...
                logger.warn("Failure event sent. mediaId={}, offset={}",
                        key, metadata.offset());
            }
        });
    }
    ...
    public void sendFailedEvent(AssetTranscodingFailureEvent event) {
        ...
        producer.send(record, (metadata, exception) -> {
            if (exception != null) {
                ...
                logger.warn("Failure event sent. assetId={}, offset={}",
                        key, metadata.offset());
            }
        });
    }
